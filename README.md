...
This table lists the configuration variables required to operate Censys. These variables are specified when configuring a Censys asset in Splunk SOAR.
...
action_result.data.\*.result.services.\*.banner | string | | HTTP/1.1 404 Not Found Server: Apache Content-Type: text/html; charset=iso-8859-1 Date: <REDACTED> Connection: close Content-Length: 196 |
...
action_result.data.\*.result.services.\*.http.response.body | string | | <!DOCTYPE HTML PUBLIC "-//IETF//DTD HTML 2.0//EN"> <html><head> <title>404 Not Found</title> </head><body> <h1>Not Found</h1> <p>The requested URL was not found on this server.</p> </body></html> |
